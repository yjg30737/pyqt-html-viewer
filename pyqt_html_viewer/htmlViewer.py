...
class HtmlViewer(QMainWindow):
    ...
    def __setActions(self):
        ...
        loadFileBtn = SvgIconPushButton(self)
        loadFileBtn.setIcon('ico/add_file.svg')
        loadFileBtn.setToolTip('Open files...')
        loadFileBtn.clicked.connect(self.__loadFile)
        self.__loadFileAction.setDefaultWidget(loadFileBtn)

        self.__loadDirAction = QWidgetAction(self)
        loadDirBtn = SvgIconPushButton(self)
        loadDirBtn.setIcon('ico/add_dir.svg')
        loadDirBtn.setToolTip('Open directory...')
        loadDirBtn.clicked.connect(self.__loadDir)
        ...
        htmlFileListToggleBtn.setCheckable(True)
        htmlFileListToggleBtn.setToolTip('Show files list')
        htmlFileListToggleBtn.toggled.connect(self.__htmlFileListToggle)
        ...
        showNavigationToolbarBtn.setCheckable(True)
        showNavigationToolbarBtn.setChecked(True)
        showNavigationToolbarBtn.setToolTip('Hide navigation toolbar')
        showNavigationToolbarBtn.toggled.connect(self.__showNavigationToolbar)
        ...
        srcWidgetToggleBtn.setCheckable(True)
        srcWidgetToggleBtn.setToolTip('Show source browser')
        srcWidgetToggleBtn.toggled.connect(self.__srcWidgetToggle)
